...
const ROLE_PERMISSIONS: Record<string, PermKey[]> = {
  Owner: [
    ...
    'PURCHASE.READ', 'PURCHASE.CREATE', 'PURCHASE.UPDATE', 'PURCHASE.APPROVE', 'PURCHASE.EXPORT',
    ...
    'POS.READ', 'POS.CREATE', 'POS.VOID', 'POS.EXPORT',
    'INVOICE.READ', 'INVOICE.CREATE', 'INVOICE.UPDATE', 'INVOICE.POST', 'INVOICE.EXPORT', 'INVOICE.WRITE_OFF',
